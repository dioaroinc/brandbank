...
$page_url = 'manage/faq';
?>
<form method="post" action="<?= base_url('manage/faq_delete_selected') ?>" onsubmit="return confirm('정말 삭제하시겠습니까?');">
<div class="container">
    ...
    <div class="notice_filter">
        <div class="flt_r" style="display: flex; align-items: center;">
            ...
            <a href="<?= base_url('manage/faq_write') ?>" class="btn_register">FAQ 등록</a>
    ...
    <?php if (!empty($faqs)) : ?>
        <?php foreach ($faqs as $faq) : ?>
            <div class="noti_t">
                <div class="td10">
                    <input type="checkbox" name="delete_ids[]" value="<?= $faq->num ?>">
                </div>
                <div class="td70" onclick="location.href='<?= base_url('manage/faq_view/' . $faq->num) ?>'">
