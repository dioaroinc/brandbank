<div class="container">
    ...
    <div class="noti_view">
        ...
        <div class="noti_view_bt" style="margin-top: 40px; text-align: center;">
            <a href="<?= base_url('web/faq'); ?>" class="btn_list">목록으로</a>
        </div>
    </div>
    ...
    <div class="noti_prev">
        <?php if ($prev_faq) : ?>
            <span>이전글</span><br />
            <a href="<?= base_url('web/faq_view/' . $prev_faq->num) ?>">
    ...
    <div class="noti_next">
        <?php if ($next_faq) : ?>
            <span>다음글</span><br />
            <a href="<?= base_url('web/faq_view/' . $next_faq->num) ?>">
